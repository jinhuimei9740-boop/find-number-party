...
function render() {
  ...
  elements.startBtn.disabled = !joined || state.room.phase !== "lobby";
  elements.endBtn.disabled = !joined || state.room.phase !== "playing";
  elements.resetBtn.disabled = !joined || state.room.phase !== "lobby";
  ...
  for (const input of elements.settingsForm.querySelectorAll("input")) {
    input.disabled = !joined || state.room.phase !== "lobby";
  }
